	...
	const handleSubmit = async (values: PaymentRecord & { name: string }) => {
		...
		data && navigate(`/success`, {
			state: {
				...
				description: 'We will get back to you in 2 business days, please email us at kongtsey@gmail.com if you have any inquiries.'
			}
		});
	};
	return (
					...
					return (
						<Form>
							<Flex
								...
								<Box w={'full'} maxW={'md'} m={2}><StatsCard title="Subscription Amount" stat="Nu 1000 | 1500 | 6500" icon={<FaMoneyBillAlt size={'3em'}/>}/></Box>
